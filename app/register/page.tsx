                ...
                <div className="card-body" id="register">
                    ...
                    <div className="flex flex-col gap-4 text-center mt-6">
                        ...
                        <button className="btn" onClick={async () => {
                            // Next auth signup is for backup only
                            // await handleSignUp({ formValue, dispatch });

                            // Better auth signup method
                            const res = await authClient.signUp.email({ email: formValue.email, password: formValue.password, name: formValue.username });
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="btn btn-outline" onClick={async () => await authClient.signIn.social({ provider: 'google', callbackURL: '/' })}>
                        ...
                        <div className="btn btn-outline" onClick={async () => await authClient.signIn.social({ provider: 'github', callbackURL: '/' })}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24"
                                height="24">
                                <path
